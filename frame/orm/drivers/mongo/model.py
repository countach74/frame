...
class Model(object):
	...
	@classmethod
	def make_new_form(self, *args, **kwargs):
		return BasicForm(self.structure).render(*args, **kwargs)

	def make_edit_form(self, *args, **kwargs):
		return BasicForm(self.structure, self._data).render(*args, **kwargs)
